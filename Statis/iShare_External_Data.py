...
print ' '
print "Department_Name_Level_1\t\tAll_User\tArticles\tUsage_Rate"
print '' 
...
for a_dep in All_Dep.keys():
    ...
    print a_dep + " "*(DEP_NAME_LEN-len(a_dep)) + "\t\t" + str(all_user) + "\t\t" + str(len(All_iShare_ID)) + "\t\t" + str(round(all_fill/all_user,4)*100) 


print ' '
print u"Department_Name_Level_2         \t\tAll_User\tArticles\tUsage_Rate"
print ''
DEP_NAME_LEN = 35  
# DEP2 
for a_dep in All_Dep.keys():
    ...
    for a_dep2 in All_Dep[a_dep].keys():
        ...
        print tmp + " "*(DEP_NAME_LEN-len(a_dep)) + "\t" + str(all_user) + "\t\t" + str(len(All_iShare_ID)) + "\t\t" + str(round(all_fill/all_user,4)*100) 


print ' '
print u"Department_Name_Level_3                    \t\tAll_User\tArticles\tUsage_Rate"
print ''
DEP_NAME_LEN = 50 
# DEP3 
for a_dep in All_Dep.keys():
